...
/////////////////
const BotName = 'Rokhim_BOT'; //ini nama bot lo
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@kreasi.editing_official')
